...
from src.problems.problem_sbrp.domain.model.student import Student


class Utils:
    @staticmethod
    def calculate_distance_euclidian(coord1_x, coord1_y, coord2_x, coord2_y):
    ...
    def calculate_cost_matrix(sbrp, entities1, entities2):
        ...
        for entity1 in entities1:
            for entity2 in entities2:
                distance = Utils.calculate_distance_euclidian(entity1.coord_x, entity1.coord_y, entity2.coord_x, entity2.coord_y)
